...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var app_tools_analytics_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! app/tools/analytics.service */ "./src/app/tools/analytics.service.ts");
...
var BusService = /** @class */ (function () {
    function BusService(log) {
        ...
        this.tokenErr$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](null);
        ...
        this.organization$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](null);
        this.isPrintingMode$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](false);
    }
    BusService.prototype.getMessage$ = function () {
        return this.message$.asObservable();
    };
    BusService.prototype.getTokenErr$ = function () {
    ...
    BusService.prototype.emitHttpError = function (error) {
        ...
        this.emit({ level: app_tools_message_model__WEBPACK_IMPORTED_MODULE_2__["Level"].ERROR, code: error.statusText });
    };
    BusService.prototype.emitTokenError = function (error) {
        this.sendEvent('I.Error.HTTP.Token', error);
        this.tokenErr$.next(error.message);
        this.emit({ level: app_tools_message_model__WEBPACK_IMPORTED_MODULE_2__["Level"].WARNING, code: error.statusText });
    };
    BusService.prototype.sendEvent = function (category, error) {
        this.log.sendEvent(category, this.getMessageFromResponse(error), error.message || error.toString());
    };
    ...
    BusService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [app_tools_analytics_service__WEBPACK_IMPORTED_MODULE_1__["LoggingService"]])
    ], BusService);
    return BusService;
}());
...
module.exports = "<ul class=\"menu\">\r\n  <main>\r\n    <li class=\"menu-item\">\r\n      <a\r\n        *ngIf=\"user\"\r\n        routerLink=\"me\"\r\n        routerLinkActive=\"active-link\"\r\n        [routerLinkActiveOptions]=\"{ exact: true }\"\r\n      >\r\n        <i class=\"icon icon-people mr-5\"></i> {{ user.name }}\r\n      </a>\r\n      <a *ngIf=\"!user\" routerLink=\"login\">\r\n        <i class=\"icon icon-people mr-5\"></i> Entrar\r\n      </a>\r\n    </li>\r\n    <li class=\"divider\" [attr.data-content]=\"title\"></li>\r\n    <ng-container *ngFor=\"let menuLink of menuLinks\">\r\n      <li class=\"menu-item\">\r\n        <a\r\n          [routerLink]=\"menuLink.link\"\r\n          routerLinkActive=\"active-link\"\r\n          [routerLinkActiveOptions]=\"{ exact: true }\"\r\n        >\r\n          <i [class]=\"'icon mr-5 ' + menuLink.icon\"></i> {{ menuLink.label }}\r\n        </a>\r\n      </li>\r\n    </ng-container>\r\n    <a\r\n      *ngIf=\"user && user.roles && user.roles.includes('MESTRE')\"\r\n      class=\"btn btn-center\"\r\n      routerLink=\"/me/events/new\"\r\n    >\r\n      <i class=\"icon icon-plus\"></i> CREAR OFERTA\r\n    </a>\r\n  </main>\r\n</ul>\r\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _analytics_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./analytics.service */ "./src/app/tools/analytics.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyErrorHandler = /** @class */ (function () {
    ...
    MyErrorHandler.prototype.getMessage = function (error) {
        return error.message || error.toString();
    };
    MyErrorHandler.prototype.getMessageFromResponse = function (error) {
        return error.status + " - " + (error.statusText || '') + " @ " + error.url;
    };
    MyErrorHandler.prototype.isSecurityError = function (err) {
    ...
    MyErrorHandler = __decorate([
        ...
        __metadata("design:paramtypes", [_analytics_service__WEBPACK_IMPORTED_MODULE_2__["LoggingService"]])
    ], MyErrorHandler);
...
var ErrorInterceptor = /** @class */ (function () {
    ...
    ErrorInterceptor.prototype.isTokenError = function (err) {
        return (err.status === 401 /* UNAUTHORIZED */ ||
            err.status === 419 /* AUTHENTICATION_TIMEOUT */);
    };
...
var MessagesService = /** @class */ (function () {
    function MessagesService(schema) {
        var _this = this;
        this.schema = schema;
        this.icons = ['icon-minus', 'icon-check', 'icon-search', 'icon-stop'];
        this.classes = ['primary', 'success', 'warning', 'error'];
        this.schema.getSchema$('messages').subscribe(function (s) {
            _this.texts = s.texts;
        });
    }
...
/* harmony import */ var _bus_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./bus.service */ "./src/app/tools/bus.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SecurityService = /** @class */ (function () {
    ...
    SecurityService.prototype.logInUser = function (credentials) {
        var _this = this;
        this.http.post(this.url, credentials).subscribe(function (r) {
            _this.log.sendEvent('users', 'login', credentials ? credentials.email : '');
            _this.saveUserToken(r);
            _this.getMe().subscribe(_this.emitLogin.bind(_this));
        });
    };
    ...
    SecurityService.prototype.checkBigbang = function () {
        var _this = this;
        this.http.get(this.url + "/bigbang").subscribe(function (r) { return _this.checkMe(); });
    };
    ...
    SecurityService.prototype.getMe = function () {
        return this.http.get(this.userUrl + "/me").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(this.saveUser.bind(this)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(this.getOrganization.bind(this)));
    };
    SecurityService.prototype.onTokenErrLogOut = function () {
        var _this = this;
        this.bus.getTokenErr$().subscribe(function (err) {
            if (!err) {
                return;
            }
    ...
    SecurityService.prototype.confirmInvitation = function (credentials) {
        var _this = this;
        this.http.post(this.url + "/confirmations", credentials).subscribe(function (r) {
    ...
    SecurityService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        __metadata("design:paramtypes", [_bus_service__WEBPACK_IMPORTED_MODULE_6__["BusService"],
            _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            app_tools_analytics_service__WEBPACK_IMPORTED_MODULE_3__["LoggingService"]])
    ], SecurityService);
