...
/* harmony import */ var app_tools_analytics_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/tools/analytics.service */ "./src/app/tools/analytics.service.ts");
...
var MeService = /** @class */ (function () {
    ...
    MeService.prototype.getAdministratedOrganization = function (id) {
        return this.http.get(this.organizationsUrl + "/" + id);
    };
    ...
    MeService.prototype.inviteUser = function (newUser) {
        ...
        return this.http
            ...
            return _this.log.sendEvent('Invitations', user.name, JSON.stringify(newUser));
        }));
    };
    ...
    MeService.prototype.getOrganizations = function () {
        return this.http.get(this.organizationsUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
    ...
    MeService.prototype.bookEvent = function (payload) {
        ...
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (x) {
            return _this.log.sendEvent('Bookings', user.name, JSON.stringify(payload));
        }));
    };
    MeService.prototype.bookEventGuest = function (payload) {
        ...
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (x) {
            return _this.log.sendEvent('Bookings.Registrations', user ? user.name : 'anonymous', JSON.stringify(payload));
        }));
    };
    ...
    MeService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"],
            ...
            app_tools_analytics_service__WEBPACK_IMPORTED_MODULE_2__["LoggingService"]])
    ], MeService);
    return MeService;
}());
